...
namespace ERP
{
    public partial class purchaseOrder : Form
    {
        ...
        private void vendorInfo()
        {
            ...
            mc.conn.Open();
            OleDbCommand cmd1 = new OleDbCommand("select * from Vendor;", mc.conn);
            OleDbDataReader dr = cmd1.ExecuteReader();
            while (dr.Read())
            {
                this.comboBox3.Items.Add(dr["VID"]);
        ...
        private void comboBox3_SelectedIndexChanged(object sender, EventArgs e)
        {
            myConnection mc = new myConnection();
            mc.conn.Open();
            OleDbCommand cmd1 = new OleDbCommand("select * from Vendor where VID='" + this.comboBox3.Text + "';", mc.conn);
            OleDbDataReader dr = cmd1.ExecuteReader();
            while (dr.Read())
            {
        ...
        private void countQuery()
        {
            myConnection mc = new myConnection();
            mc.conn.Open();
            OleDbCommand cmd1 = new OleDbCommand("select count(POID) from POProducts;", mc.conn);
            OleDbDataReader dr = cmd1.ExecuteReader();
            while (dr.Read())
            {
        ...
        private void removeAddProductFromdb() {
            myConnection mc = new myConnection();
            mc.conn.Open();
            OleDbCommand cmd1 = new OleDbCommand("delete from POProducts where POID ='" + this.textBox9.Text + "'", mc.conn);
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            myConnection mc = new myConnection();
            mc.conn.Open();
            OleDbCommand cmd = new OleDbCommand("update PO SET Approve = '" + this.comboBox4.Text + "' where POID='" + this.comboBox1.Text + "';", mc.conn);
            cmd.ExecuteReader();
